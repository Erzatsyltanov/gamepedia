...
const designersData = [
  ...
  },
  {
    ...
    bio: "Эдвард Бун родился 22 февраля 1964 года в Чикаго, США. Он начал свою карьеру в Williams Electronics как программист. Вместе с Джоном Тобиасом создал Mortal Kombat в 1992 году, которая произвела фурор благодаря реалистичной по тем временам графике и жестоким добиваниям (fatality). Бун был не только программистом игры, но и послужил моделью для персонажа Джонни Кейджа, а также записал знаменитую фразу 'Get over here!' для Скорпиона. После более чем 30 лет работы над серией, он до сих пор остаётся её руководителем и одним из главных лиц NetherRealm Studios. Бун активно взаимодействует с фанатским сообществом и известен своим чувством юмора."
  },
  {
    id: 8,
    name: "Джон Кармак",
